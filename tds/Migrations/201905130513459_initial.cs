namespace tds.Migrations
{
    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        id = c.String(nullable: false, maxLength: 128),
                        deductorId = c.String(maxLength: 128),
                        contractorId = c.String(nullable: false, maxLength: 128),
                        ...
                        labourCessAmount = c.Double(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Transactions", "deductorId", "dbo.Deductors");
            ...
            DropIndex("dbo.Transactions", new[] { "deductorId" });
